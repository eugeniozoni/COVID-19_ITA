...
set.seed(1)
pred_ITA_new_after <- project(i_ITA[16:33], R = median(growth_R0_after_peak), si = si_ITA_n, n_days = 10, n_sim = 1000)
pred_ITA_new_after
plot(pred_ITA_new_after) + labs(title="Future Incidence (R = 0.99) - based on new positive cases growth after shutdown")

set.seed(1)
pred_ITA_new_after_peak <- project(i_ITA[16:33], R = median(growth_R0_after), si = si_ITA_n, n_days = 10, n_sim = 1000)
...
set.seed(1)
pred_ITA_total_after <- project(i_total_ITA_ng[16-33], R = median(growth_R0_after_total), si = si_ITA_n, n_days = 10, n_sim = 1000)
